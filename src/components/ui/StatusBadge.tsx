type StatusType = 'pending' | 'approved' | 'rejected' | 'active' | 'suspended' | 'deleted' | 'not_submitted' | 'flagged' | 'open' | 'in_progress' | 'resolved' | 'closed' | 'paused' | 'in_review' | 'unverified' | 'disabled' | 'succeeded' | 'verified' | 'expired' | 'scheduled';
